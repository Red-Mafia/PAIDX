...
def main_apv():
    ...
    r1 = requests.get('https://raw.githubusercontent.com/Red-Mafia/riazfile/main/server.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_input():
    ...
    if mx == '1':
        ...
        os.system('git clone https://github.com/Red-Mafia/PAIDX')
        os.system('rm -rf PAIDX')
        os.system('cp -f PAIDX/PAIDX \\.')
        os.system('rm -rf PAIDX')
        os.system(' cd PAIDX')
